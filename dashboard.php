...
/*
$crypto_prices['BTC'] 	= get_crypto_prices('BTC');
$crypto_prices['DASH'] 	= get_crypto_prices('DASH');
$crypto_prices['BCH'] 	= get_crypto_prices('BCH');
$crypto_prices['ETH'] 	= get_crypto_prices('ETH');
$crypto_prices['ETC'] 	= get_crypto_prices('ETC');
$crypto_prices['SC'] 	= get_crypto_prices('SC');
$crypto_prices['LTC'] 	= get_crypto_prices('LTC');
$crypto_prices['ZEC'] 	= get_crypto_prices('ZEC');
$crypto_prices['XRP'] 	= get_crypto_prices('XRP');
$crypto_prices['XMR'] 	= get_crypto_prices('XMR');
$crypto_prices['ETN'] 	= get_crypto_prices('ETN');
*/
...
This website is operated by DeltaColo LTD. Throughout the site, the terms “we”, “us” and “our” refer to DeltaColo LTD. DeltaColo LTD offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
...
In no case shall DeltaColo LTD, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.



SECTION 14 - INDEMNIFICATION

You agree to indemnify, defend and hold harmless DeltaColo LTD and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
...
These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of Suite 1.01 The Bloc, Ashley Road, Altrincham, GBN, WA14 2DW, United Kingdom.
...
Questions about the Terms of Service should be sent to us at admin@deltacolo.com.
						</textarea>
					</p>
				</div>
	...
	<div class="modal fade" id="modal-discord-chat">
		<div class="modal-dialog" style="width: 80%;">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Chat & Support</h4>
				</div>
				<div class="modal-body">
					<!-- <iframe src="https://discordapp.com/widget?id=425050749399990272&theme=dark&username=<?php echo $_SESSION['account']['email']; ?>" width="350" height="500" allowtransparency="true" frameborder="0"></iframe> -->
					<iframe src="https://titanembeds.com/embed/425050749399990272?username=<?php echo $_SESSION['account']['email']; ?>" height="600" width="100%" frameborder="0"></iframe>
				</div>
				<div class="modal-footer">
